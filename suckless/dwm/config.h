...
static const char *fonts[]          = { "monospace:size=16", "BitstreamVeraSansMono Nerd Font:pixelsize=25", "JoyPixels:pixelsize=16"};
...
/* 
 * Start of alpha status bar patch
...
static const char *downbrightness[] = {"/home/caleb/.local/bin/brightness_down", NULL};
